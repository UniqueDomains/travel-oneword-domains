# Available .TRAVEL One-Word Domains (5,622,086)
...
> **Important:** this repository is a **public 8,608-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,086 domains** on the canonical page below.

**Public extract:** 8,608 rows · **Live catalog:** 5,622,086 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/travel?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_travel_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/travel?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_travel_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./travel.csv">CSV</a> / <a href="./travel.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_travel_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_travel_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .TRAVEL search](https://unique.domains/domains/tld/travel?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_travel_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .TRAVEL search](https://unique.domains/domains/tld/travel?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_travel_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./travel.csv) or [Download JSON](./travel.json)
...
- `travel.csv` — public CSV extract (8,608 rows)
- `travel.json` — public JSON extract (8,608 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,608-row public sample | 5,622,086 live domains                           |
...
| --------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ----------------- |
| daniel.travel   | available | $39.99    | —             | 76             | 51     | 6      | name.com          |
| gold.travel     | resell    | —         | —             | 72             | 99     | 4      | Sav.com, LLC - 34 |
| alive.travel    | premium   | —         | —             | 84             | 99     | 5      | —                 |
| support.travel  | available | $39.99    | —             | 90             | 48     | 7      | name.com          |
| taiwan.travel   | resell    | —         | —             | 66             | 92     | 6      | Dynadot Inc       |
| park.travel     | premium   | —         | —             | 77             | 99     | 4      | —                 |
| event.travel    | available | $39.99    | —             | 78             | 48     | 5      | name.com          |
| discover.travel | resell    | —         | —             | 66             | 75     | 8      | Epik LLC          |
| whatever.travel | premium   | —         | —             | 116            | 98     | 8      | —                 |
| strategy.travel | available | $186.98   | —             | 74             | 43     | 8      | namecheap         |
| solo.travel     | resell    | —         | —             | 116            | 68     | 4      | Key-Systems GmbH  |
| audible.travel  | premium   | —         | —             | 112            | 98     | 7      | —                 |
| mark.travel     | available | $39.99    | $189.99       | 66             | 42     | 4      | name.com          |
| now.travel      | resell    | —         | —             | 78             | 66     | 3      | GoDaddy.com, LLC  |
| punk.travel     | premium   | —         | —             | 102            | 98     | 4      | —                 |
| order.travel    | available | $39.99    | $189.99       | 78             | 41     | 5      | name.com          |
| ant.travel      | resell    | —         | —             | 86             | 60     | 3      | Dynadot Inc       |
| sapphire.travel | premium   | —         | —             | 92             | 98     | 8      | —                 |
| learning.travel | available | $186.98   | —             | 76             | 41     | 8      | namecheap         |
...
> Unique Domains. *Available .TRAVEL One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
